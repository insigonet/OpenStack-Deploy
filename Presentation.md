...
---
### **Слайд 11: «Мой опыт развёртывания OpenStack»**
### **Основные фразы для слайда:**
...
- Добавление новых сервисов для расширения инфраструктуры:
  - **Cinder** (дополнительные тома\volume)
...
1. **Добавление томов (Cinder):** Клиент может подключить к виртуальной машине дополнительный том, если текущего места не хватает. Это позволяет легко расширить дисковое пространство.
